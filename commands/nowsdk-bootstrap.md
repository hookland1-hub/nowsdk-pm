---
description: Scaffold a Now SDK project for a scoped app — deliverable live (with auth) or fully offline as a no-auth Update Set XML.
argument-hint: "[target folder]"
---

Invoke the `nowsdk-bootstrap` skill to scaffold a Now SDK project (Fluent scaffold, converter,
